        ...
        <div className="max-w-5xl mx-auto px-6 py-8">
          {isLoadingDocs ? (
            ...
            <div className="space-y-8">
              ...
              {/* F2-M6.3 — Starred section: shown whenever there are starred items, never in Archived view */}
              {!showArchived && (groupedView.starred.length > 0 || groupedView.starredFolders.length > 0) && <section>
