...
export function createAIProvider(providerName: string, config: AIConfig): AIProvider {
  ...
  switch (name) {
    case 'groq': {
      ...
      return new OpenAIProvider(apiKey, model, PROVIDER_BASE_URLS.groq);
    }
    ...
    case 'openrouter': {
      ...
      return new OpenAIProvider(apiKey, model, PROVIDER_BASE_URLS.openrouter);
    }
    ...
    case 'google': {
      ...
      return new OpenAIProvider(apiKey, model, PROVIDER_BASE_URLS.google);
    }
