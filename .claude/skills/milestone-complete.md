...
**Cuándo usar:** Cuando todas las tareas de un milestone están completas y el reviewer ha dado el visto bueno.
...
Confirmar que el reviewer ha aprobado el milestone.
...
- Archivo HTML en `.claude/reports/fase-XX-milestone-XX-nombre.html`
...
```
[📊 REPORTER] Milestone F2-MX completado.
